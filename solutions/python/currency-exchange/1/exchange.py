...
def exchange_money(budget, exchange_rate):
    ...
    """
    budget = float(budget)
    exchange_money= float(exchange_rate)
...
def get_change(budget, exchanging_value):
    ...
    """
    budget = float(budget)
    exchangeable_value = float(exchanging_value)
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    num_of_bills = denomination* number_of_bills
    return int(num_of_bills)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    rate = int(rate)
    bills= int(rate/denomination)
    actual_amount = denomination*bills
