...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    _90_percent = threshold * 0.9
    _10_percent = threshold * 0.01
    _110_percent = threshold * 1.1
    if prod > _110_percent:
        return "DANGER"
    elif prod < _90_percent:
        return "LOW"
    elif prod > _90_percent *100 and prod< _110_percent:
        return "NORMAL"
    else:
        return "NORMAL"
