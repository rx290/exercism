...
def approx_average_is_average(hand):
    ...
    """
    if (hand[0]+hand[-1])/2 == card_average(hand) or s.median(hand) == card_average(hand):
        return True
    return False
...
def average_even_is_average_odd(hand):
    ...
    """
    even_lst = [even_index for even_index in hand[::2]]
    even_avg = sum(even_lst)/len(even_lst)
    odd_lst = [odd_index for odd_index in hand[1::2]]
